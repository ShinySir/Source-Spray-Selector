...
Source Spray Selector is a simple spray selector desktop application GUI written in Rust using [`egui`](https://www.egui.rs/) for browsing, previewing, and managing `.vtf` spray files used in Source engine games like Team Fortress 2, Garry's Mod, etc.
